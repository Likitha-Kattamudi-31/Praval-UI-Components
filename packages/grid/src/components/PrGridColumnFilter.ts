import { LitElement, PropertyValues, html, nothing, svg } from 'lit';
...
export class PrGridColumnFilter extends LitElement {
  static readonly styles = [PrGridViewStyles, PrGridColumnFilterStyles];
