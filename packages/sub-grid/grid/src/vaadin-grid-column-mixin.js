  ...
  class extends ColumnBaseMixin(DirMixin(superClass)) {
    static get properties() {
      return {
        ...
        /**
         * Ordered tuple array of responsive widths, the first item is the screen size, the second is the width of column at that size.
         * must be in sequential order from smallest to largest.
         * @type {[string, string][]}
         */
        responsive: {
          type: Array,
