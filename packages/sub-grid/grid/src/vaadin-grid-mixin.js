...
export const GridMixin = (superClass) =>
  class extends ColumnAutoWidthMixin(
    ...
    /** @private */
    _createCell(tagName, column, columnName) {
      ...
      const cell = document.createElement(tagName);visu
      if (columnName) {
        cell.setAttribute('data-testid', `colname-${columnName}`);
      }
      ...
      columns
        ...
        .forEach((column, index, cols) => {
          ...
          if (section === 'body') {
            ...
            if (!cell) {
              cell = this._createCell('td', column, column.getAttribute('path'));
    ...
    _updateScrollerItem(row, index) {
      ...
      this._testIdUpdateRowRowindex(row, index);
    ...
    _renderColumnTree(columnTree) {
      ...
      this._testIdUpdateHeaderRows();
      this._a11yUpdateFooterRows();
      this._testIdUpdateFooterRows();
